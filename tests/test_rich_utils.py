...
class TestGetConsole:
    ...
    def test_verbose_returns_normal_console(self):
        from rdt.shared.rich_utils import console, get_console
    ...
    def test_quiet_returns_quiet_console(self):
        from rdt.shared.rich_utils import get_console, quiet_console

        result = get_console(verbose=False)
        assert result is quiet_console

    def test_stderr_verbose_returns_stderr_console(self):
        from rdt.shared.rich_utils import console_err, get_console
    ...
    def test_stderr_quiet_returns_quiet_stderr_console(self):
        from rdt.shared.rich_utils import get_console, quiet_console_err
...
class TestPrintHeader:
    ...
    def test_print_header_no_subtitle(self, capsys):
        from rdt.shared.rich_utils import print_header
...
class TestCreateProgressBar:
    ...
    def test_returns_progress_instance(self):
        from rdt.shared.rich_utils import create_progress_bar
...
class TestCreateSummaryTable:
    ...
    def test_returns_table_instance(self):
        from rdt.shared.rich_utils import create_summary_table
...
class TestPrintSeparator:
    ...
    def test_runs_without_error(self):
        from rdt.shared.rich_utils import print_separator
...
class TestPrintSection:
    ...
    def test_runs_without_error(self):
        from rdt.shared.rich_utils import print_section
